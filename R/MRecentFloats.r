...
#' @export
MRecentFloats <- R6::R6Class("MRecentFloats", public = list(VersionNumber = NULL,
    m_Values = NULL, initialize = function(VersionNumber, m_Values) {
        ...
        if (!is.null(MRecentFloatsObject$VersionNumber)) {
            ...
            VersionNumberObject$fromJSON(jsonlite::toJSON(MRecentFloatsObject$VersionNumber,
                auto_unbox = TRUE))
        ...
        MRecentFloatsObject <- jsonlite::fromJSON(MRecentFloatsJson)
        VersionNumberObject <- VersionNumber$new()
        self$VersionNumber <- VersionNumberObject$fromJSON(jsonlite::toJSON(MRecentFloatsObject$VersionNumber,
            auto_unbox = TRUE))
        self$m_Values <- MRecentFloatsObject$m_Values
    }))
