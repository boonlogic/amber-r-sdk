...
MAP <- R6::R6Class(
  ...
  public = list(
    `VersionNumber` = NULL,
    `m_AutotuneRange` = NULL,
    `m_AutotunePV` = NULL,
    `m_AutotuneByFeatures` = NULL,
    `m_MaxClusters` = NULL,
    `m_FeaturesToTuneArray` = NULL,
    initialize = function(`VersionNumber`, `m_AutotuneRange`, `m_AutotunePV`, `m_AutotuneByFeatures`, `m_MaxClusters`, `m_FeaturesToTuneArray`){
    ...
    toJSONString = function() {
       sprintf(
        ...
        self$`m_AutotuneRange`,
        self$`m_AutotunePV`,
        self$`m_AutotuneByFeatures`,
        self$`m_MaxClusters`,
