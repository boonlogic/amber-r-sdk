...
#' @export
MRecentAMs <- R6::R6Class("MRecentAMs", public = list(VersionNumber = NULL, m_Values = NULL,
    initialize = function(VersionNumber, m_Values) {
        ...
        if (!is.null(MRecentAMsObject$VersionNumber)) {
            ...
            VersionNumberObject$fromJSON(jsonlite::toJSON(MRecentAMsObject$VersionNumber,
                auto_unbox = TRUE))
...
intf("{
        ...
        MRecentAMsObject <- jsonlite::fromJSON(MRecentAMsJson)
        VersionNumberObject <- VersionNumber$new()
        self$VersionNumber <- VersionNumberObject$fromJSON(jsonlite::toJSON(MRecentAMsObject$VersionNumber,
            auto_unbox = TRUE))
        self$m_Values <- MRecentAMsObject$m_Values
    }))
