...
#'
#' @export
ApiClient <- R6::R6Class("ApiClient", public = list(basePath = "http://amber.boonlogic.com/v1",
    configuration = NULL, userAgent = NULL, defaultHeaders = NULL, initialize = function(basePath,
