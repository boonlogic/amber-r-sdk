...
#' @export
MStreamingParameters <- R6::R6Class(
  'MStreamingParameters',
  public = list(
    `VersionNumber` = NULL,
    `m_EnableAutotuning` = NULL,
    `m_SamplesToBufferForAutotuning` = NULL,
    `m_GraduationAtRateNumerator` = NULL,
    `m_GraduationAtRateDenominator` = NULL,
    `m_GraduateAtMaxClusters` = NULL,
    `m_GraduateAtMaxSamples` = NULL,
    initialize = function(`VersionNumber`, `m_EnableAutotuning`, `m_SamplesToBufferForAutotuning`, `m_GraduationAtRateNumerator`, `m_GraduationAtRateDenominator`, `m_GraduateAtMaxClusters`, `m_GraduateAtMaxSamples`){
      ...
      if (!missing(`m_SamplesToBufferForAutotuning`)) {
        stopifnot(is.numeric(`m_SamplesToBufferForAutotuning`), length(`m_SamplesToBufferForAutotuning`) == 1)
        self$`m_SamplesToBufferForAutotuning` <- `m_SamplesToBufferForAutotuning`
      }
      if (!missing(`m_GraduationAtRateNumerator`)) {
        stopifnot(is.numeric(`m_GraduationAtRateNumerator`), length(`m_GraduationAtRateNumerator`) == 1)
        self$`m_GraduationAtRateNumerator` <- `m_GraduationAtRateNumerator`
      }
      if (!missing(`m_GraduationAtRateDenominator`)) {
        stopifnot(is.numeric(`m_GraduationAtRateDenominator`), length(`m_GraduationAtRateDenominator`) == 1)
        self$`m_GraduationAtRateDenominator` <- `m_GraduationAtRateDenominator`
      }
      if (!missing(`m_GraduateAtMaxClusters`)) {
        stopifnot(is.numeric(`m_GraduateAtMaxClusters`), length(`m_GraduateAtMaxClusters`) == 1)
        self$`m_GraduateAtMaxClusters` <- `m_GraduateAtMaxClusters`
      }
      if (!missing(`m_GraduateAtMaxSamples`)) {
        stopifnot(is.numeric(`m_GraduateAtMaxSamples`), length(`m_GraduateAtMaxSamples`) == 1)
    ...
    toJSONString = function() {
       sprintf(
        ...
        self$`m_EnableAutotuning`,
        self$`m_SamplesToBufferForAutotuning`,
        self$`m_GraduationAtRateNumerator`,
        self$`m_GraduationAtRateDenominator`,
        self$`m_GraduateAtMaxClusters`,
        self$`m_GraduateAtMaxSamples`
      )
    },
